...
import com.ariel.healthdelivery.R
import com.ariel.healthdelivery.utils.NotificationManagerUtils
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun showNotification(remoteMessage: RemoteMessage, pendingIntent: PendingIntent?) {
        ...
        val title = remoteMessage.notification?.title ?: "Health Delivery"
        val message = remoteMessage.notification?.body ?: "Que Tal andar um pouco hoeje?"
